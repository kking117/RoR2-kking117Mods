...
namespace QueenGlandBuff
{
	...
	public class MainPlugin : BaseUnityPlugin
	{
		...
		public static ConfigEntry<int> Config_QueensGland_BaseDamage;
		public static ConfigEntry<int> Config_QueensGland_BaseHealth;
		public static ConfigEntry<int> Config_QueensGland_StackDamage;
		public static ConfigEntry<int> Config_QueensGland_StackHealth;
		//Staunch Buff
		...
		public static ConfigEntry<float> Config_Staunch_Armor;
		//Leash
		...
		private void ReadConfig()
		{
			...
			Config_QueensGland_StackDamage = Config.Bind<int>(new ConfigDefinition("Queens Gland", "StackDamage"), 20, new ConfigDescription("How many extra DamageBonus to give when stacking above Max Summons.", null, Array.Empty<object>()));
			...
			Config_Staunch_AggroRange = Config.Bind<float>(new ConfigDefinition("Staunch Buff", "Aggro Range"), 60f, new ConfigDescription("Enemies within this range will aggro to affected characters. (Set to 0 or less to disable the aggro effect.)", null, Array.Empty<object>()));
			...
			Config_Staunch_AggroBossChance = Config.Bind<float>(new ConfigDefinition("Staunch Buff", "Aggro Boss Chance"), 0f, new ConfigDescription("Percent chance every second that a boss will aggro onto affected characters.", null, Array.Empty<object>()));
			Config_Staunch_Armor = Config.Bind<float>(new ConfigDefinition("Staunch Buff", "Armor"), 100f, new ConfigDescription("How much armor the user gets during this buff.", null, Array.Empty<object>()));
