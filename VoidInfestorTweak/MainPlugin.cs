...
namespace TestTest
{
	...
	public class MainPlugin : BaseUnityPlugin
    {
        ...
        private void ReadConfig()
        {
            ...
            InfestFilter_Mechanical = Config.Bind<bool>(new ConfigDefinition("Global Infest Filters", "Mechanical"), false, new ConfigDescription("Should Void Infestors be able to infest Mechanical characters?", null, Array.Empty<object>()));
