...
```
- Fixed some Portal Tags using the wrong flags.
- Fixed Gilded Coast spawning two Colossus Portals in some cases.
```
...
- [Eclipse/Standard|Looping|Teleporter|Primordial Teleporter Conditions] Default configuration changed. (5 -> SO5)
```
