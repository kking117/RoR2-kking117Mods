...
namespace ZoeaRework.States.VoidJailer
{
    public class Recall : BaseSkillState
    {
		...
		private string animationStateName = "Spawn1";
		private string animationPlaybackRateParam = "Spawn1.playbackRate";
		private string spawnMuzzleName = EntityStates.VoidJailer.SpawnState.spawnFXTransformName;
		private GameObject effectPrefab = EntityStates.VoidJailer.SpawnState.spawnFXPrefab;
	}
}
