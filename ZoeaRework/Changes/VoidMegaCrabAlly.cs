...
namespace ZoeaRework.Changes
{
    public class VoidMegaCrabAlly
    {
        ...
        private static void UpdateAI()
        {
            ...
            aiskillDriver4.minDistance = 150f;
        ...
        private static void CreateUtilitySkill()
        {
            ...
            UtilitySkill.activationState = new SerializableEntityStateType(typeof(States.Recall));
        ...
        internal static void UpdateAllSummonInventory(CharacterMaster owner)
        {
            ...
            {
                int itemCount = owner.inventory.GetItemCount(DLC1Content.Items.VoidMegaCrabItem);
        ...
        internal static void UpdateInventory(CharacterMaster owner, CharacterMaster summon)
        {
            ...
            if (owneritems)
            {
                ...
                int dmg = MainPlugin.Config_Zoea_DamageBase.Value + (MainPlugin.Config_Zoea_DamageBonus.Value * itemCount);
                int hp = MainPlugin.Config_Zoea_HealthBase.Value + (MainPlugin.Config_Zoea_HealthBonus.Value * itemCount);
